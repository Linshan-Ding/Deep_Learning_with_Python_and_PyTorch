...
myfont = fm.FontProperties(fname='songti.ttf')
...
decoder_state_dict = torch.load('attn_decoder.pt')
encoder1.load_state_dict(encoder_state_dict)
attn_decoder1.load_state_dict(decoder_state_dict)
# 测试模型
